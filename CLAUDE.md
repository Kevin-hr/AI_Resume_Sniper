...
**AI Resume Sniper v1.3** - Hybrid Architecture with FastAPI Backend and Streamlit Frontend, exposed via Cloudflare Tunnel.
...
├── web_app.py            # Streamlit Frontend (Port 8501) - Mobile-optimized UI
